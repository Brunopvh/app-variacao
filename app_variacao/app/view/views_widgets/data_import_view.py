...
class DataImportConfigView(Container):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.main_container.pack(fill='both', expand=True, padx=3, pady=2)
    ...
    def _setup_csv_ui(self):
        ...
        ttk.Combobox(
            row_sep, textvariable=self.var_sep, values=[";", ",", "\\t", "|", "-"]
    ...
    def _setup_excel_ui(self):
        ...
        self.comb_sheet_names.pack(side='left', fill='x', expand=True, padx=2, pady=2)
    ...
    def update_options_ui(self):
        ...
        if path.is_csv():
            self.container_csv.pack(fill='x', pady=2)
            ...
            self.container_excel.pack(fill='x', pady=2)
